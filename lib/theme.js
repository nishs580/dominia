...
export const colors = {
  ...
  // Caution — the one sanctioned non-territory signal colour (adopted 2026-07-20).
  // Warning/paused/expiring states only. Never on CTAs, never on the map,
  // at most one caution element per screen. Not a substitute for Claim red.
  caution: '#D49A2B',
